...
public class LLVMActions extends OwnLanguageBaseListener {
    ...
    @Override
    public void enterWcond(OwnLanguageParser.WcondContext ctx) {
        LLVMGenerator.startWhile();
    }

    @Override
    public void exitBlockw(OwnLanguageParser.BlockwContext ctx) {
        LLVMGenerator.endWhile();
    }

    @Override
    public void exitWcond(OwnLanguageParser.WcondContext ctx) {
        Value v1 = stack.pop();
        Value v2 = stack.pop();
        if (v1.getType() != v2.getType()) {
            StringBuilder msg = new StringBuilder();
